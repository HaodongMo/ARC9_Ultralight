...
SWEP.Description = [[The SG 552 is a premium scoped alternative to the AK-47 for effective long-range engagement.]]

SWEP.PrintName = SWEP.TrueName

else

SWEP.Description = [[The Krieg 552 is a premium scoped alternative to the CV-47 for effective long-range engagement.]]

end

SWEP.ViewModel = "models/weapons/arc9_uli/c_rif_sg552.mdl"
SWEP.WorldModel = "models/weapons/w_rif_sg552.mdl"

SWEP.Slot = 2

SWEP.MirrorVMWM = true
SWEP.WorldModelMirror = "models/weapons/arc9_uli/m_rif_sg552.mdl"
...
SWEP.VisualRecoilCenter = Vector(7.85, 4, -2.58) -- The "axis" of visual recoil. Where your hand is.
...
SWEP.ShootSound = "weapons/sg552/sg552-1.wav"
...
SWEP.RTScopeFOV = 50
SWEP.RTScopeReticle = Material("arc9_uli/acog.png", "mips smooth")
