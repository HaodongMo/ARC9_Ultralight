...
SWEP.Description = [[As expensive as it is powerful, the Nighthawk is an iconic pistol that is difficult to master but surprisingly accurate at long range.]]
...
SWEP.WorldModelMirror = "models/weapons/cstrike/c_pist_deagle.mdl"
