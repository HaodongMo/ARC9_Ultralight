...
SWEP.Description = [[The pricy D3/AU-1 lowers movement speed considerably but compensates with a higher rate of fire than other sniper rifles.]]

end


SWEP.ViewModel = "models/weapons/arc9_uli/c_snip_g3sg1.mdl"
SWEP.WorldModel = "models/weapons/w_snip_g3sg1.mdl"

SWEP.Slot = 2

SWEP.MirrorVMWM = true
SWEP.WorldModelMirror = "models/weapons/arc9_uli/m_snip_g3sg1.mdl"
