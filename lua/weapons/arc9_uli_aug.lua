...
SWEP.Description = [[Powerful with high capacity, the AUG scoped assault rifle allows for effective suppressing fire at range.]]

SWEP.PrintName = SWEP.TrueName

else

SWEP.Description = [[Powerful with high capacity, the Bullpup scoped assault rifle allows for effective suppressing fire at range.]]

end

SWEP.ViewModel = "models/weapons/arc9_uli/c_rif_aug.mdl"
...
SWEP.ClipSize = 36 -- Self-explanatory.
...
SWEP.VisualRecoilCenter = Vector(8, 4, -1.91) -- The "axis" of visual recoil. Where your hand is.
...
SWEP.IronSights = {
    Pos = Vector(-8, -14, 1.91),
    Ang = Angle(-0.25, -3.85, -9.49839),
...
SWEP.ShootSound = "weapons/aug/aug-1.wav"
...
SWEP.RTScopeFOV = 50
SWEP.RTScopeReticle = Material("arc9_uli/aug.png", "mips smooth")
SWEP.RTScopeColor = Color(255, 255, 255)
SWEP.RTScopeShadowIntensity = 10
SWEP.ScopeScreenRatio = 0.75