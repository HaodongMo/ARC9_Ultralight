...
SWEP.Description = [[Versatile but expensive, the German-made MP5 SMG is the perfect choice for high-impact close-range combat.]]

else

SWEP.Description = [[Versatile but expensive, the German-made KM SMG is the perfect choice for high-impact close-range combat.]]
...
SWEP.PhysBulletMuzzleVelocity = 1132 * 12
...
SWEP.SprintPos = Vector(5, -6, 4)

SWEP.ActivePos = Vector(-2, -6, 0)
SWEP.ActiveAng = Angle(0, 0, 0)

SWEP.CrouchPos = Vector(-2, -8, 2)
